...
namespace APP
{
    ...
    public class Fact
    {
        ...
        string _recordNo;
        string _content;
        bool blFit;//是否符合（符合为true,偏差为false）
        string _FuHeXiang;
    ...
    public class RecordHelper
    {
        ...
        static RecordHelper()
        {
            string YapFileName = System.IO.Path.Combine(CommonHelper.GetAssemblyPath(), UserSession.LoginUser.SuoXie+".yap");
